...
const projects = [
    {
        ...
        "date": "June 2024",
        "name": "Figma Slides",
        "desc": "I had the honor of supporting <a href='https://keeyen.com/' target='blank'>Keeyen Yeo</a>, Khalil Cader, and Jakub Swiadek through the year in which they launched Figma's third product.",
        ...
        "date": "November 2023",
        "name": "FigJam AI",
        "desc": "We launched a bundle of AI features — summarization, clustering, board generation, and Jambot. I'm very proud to have supported the team that made this happen: <a href='https://www.tash.work/'>Natasha Tenggoro</a>, <a href='https://rocky.framer.website/'>Rocky Chen</a>, <a href='https://aoshengran.com/'>Aosheng Ran</a>, <a href='http://read.cv/matt'>Matt Chan</a>, and many other cross-functional folks.",
        "img": ["figjam-ai.png"],
        "link": "https://www.fastcompany.com/90978774/figmas-new-ai-powered-tools-will-make-your-meetings-suck-less",
        "cta": "Read the Fast Company feature"
    },
    {
        "date": "June 2023",
        "name": "Putting joy on the roadmap",
        "desc": "A battle cry to make software less boring and more joyful. I did this talk twice—at CanUX in October 2022, and at Config in June 2023 with <a href='https://www.linkedin.com/in/mihikakapoor/'>Mihika Kapoor</a> and <a href='https://keeyen.com/'>Keeyen Yeo</a>. And I also got to host Config again— this time on the big stage, in front of 8,000 people.",
        ...
        "cta": "Learn more about Angel Track",
    },{
        "date": "April 2023",
        ...
        "cta": "Read on Designer Fund's blog"
        ...
        "desc": "An experiment we ran that had new users pick between four simple templates. Such a fun one to jam with <a href='https://www.andrewschmidt.net/'>Andrew Schmidt</a> on.",
...
const socialTemplate = document.querySelector("#social");

socials.forEach(social => {
    const clone = socialTemplate.content.cloneNode(true);

    clone.querySelector("#social-link").href = social.link;
    clone.querySelector("#social-link").textContent = social.name;
...
projects.forEach(project => {
    ...
    const linkContainer = clone.querySelector("#link-container");
    const linkTemplate = document.querySelector("#t-link");

    const imgContainer = clone.querySelector("#img-container");
    const imgTemplate = document.querySelector("#t-img");
    ...
    // if (project.link && project.cta) {
    //     const linkClone = linkTemplate.content.cloneNode(true);
    //     linkClone.querySelector("#link").href = project.link;
    //     linkClone.querySelector("#link").textContent = project.cta;
